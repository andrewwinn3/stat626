...
plot_roots = function(phi = numeric(0), theta = numeric(0), title = NA,...){
  ...
  if((p > 0) && (q == 0)){
    ...
    plot(c(-1, 1), c(-1, 1), xlab = "Real", ylab = "Imaginary",
        type = "n", bty = "n", xaxt = "n", yaxt = "n", main = title, ...)
...
autoplot_roots <-function(phi = numeric(0), theta = numeric(0), title = "AR/MA roots",...){
